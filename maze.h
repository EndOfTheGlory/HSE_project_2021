...
public:
    ...
    // Константные геттеры - намек на то, что мы ничего не будем менять из вне
    // Ссылки нужны, так как объекты класса - увесистые
